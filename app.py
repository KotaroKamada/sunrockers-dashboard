...
try:
    ...
    numeric_columns = [
        ...
        "Sprint Momentum", "BW*20m Multh", "BSQ", "BP", "CMJ", "Pro Agility",
...
if name:
    ...
    if not user_data.empty:
        ...
        with col1:
            ...
            # 新しい変数（Weight, Fat mass(kg), LBM/m, BMI, CODD, 20m Multh）も追加
            # ==========
            columns_of_interest = [
                "Sprint Momentum", "BW*20m Multh", "LBM/m",
        ...
        with col2:
            ...
            # 重要なメトリクスを先に表示
            important_metrics = ["Sprint Momentum", "BW*20m Multh", "LBM/m"]
        ...
        <div class="purple-gradient-bg" style="border-radius: 6px 6px 0 0; margin-top: 30px; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.2);">
            <h3 style="margin: 0; letter-spacing: 1px; font-weight: 600; text-transform: uppercase;">Detailed Metrics Graphs</h3>
        </div>
        """, unsafe_allow_html=True)
